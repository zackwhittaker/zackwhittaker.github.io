QuizGenerator_quiz = function() {
  ...
  var finalScore = function () {
    ...
    $(".quiz-container")
      .html("<div class='scorecard'><p>You correctly answered</p><p>" + score + "&nbsp;out of&nbsp;" + input.length + "</p><div id='social-media'><ul><li><a class=\"fb-share\" href='http://www.facebook.com/sharer.php?u=http://www.zdnet.com/article/this-week-in-security-airport-screening-bank-hacks-dead-ransomware-quiz/" + "' target='_blank'>" + facebook + "</a></li><li><a class=\"twitter-share\" href='http://twitter.com/home?status=I scored " + score + "/" + input.length + " on the @ZDNet weekly security quiz: http://zd.net/1XEFMKy" + "' target='_blank'>" + twitter   + "</a></li><li><a class=\"gplus-share\" href='https://plus.google.com/share?url=http://www.zdnet.com/article/this-week-in-security-airport-screening-bank-hacks-dead-ransomware-quiz/" + "' target='_blank'>" + google + "</a></li></ul></div><p>Tune in again next week for a new quiz.</p></div>");
